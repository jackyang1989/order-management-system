            ...
            <ProfileContainer className="py-4">
                {loading ? (
                    ...
                    <div className="space-y-4">
                        {cards.map(card => (
                            <Card key={card.id} className={cn('relative overflow-hidden border-slate-200 shadow-sm transition-all', card.isDefault ? 'border-blue-500 bg-blue-50/30' : 'bg-white')}>
                ...
                <div className="mt-6 rounded-lg bg-amber-50 p-4 text-xs text-amber-700 leading-relaxed shadow-sm">
