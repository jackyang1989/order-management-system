            ...
            <div className="mb-8 flex gap-6">
                ...
                <div className="flex-1 rounded-md border border-[#e5e7eb] bg-white p-6">
                    ...
                    <div>
                        ...
                        {data.praiseFee > 0 && <div className="mb-2 flex justify-between text-sm text-[#6b7280]"><span>好评增值费 ({f(data.praiseFee)} × {data.count})</span><span>¥{f(data.praiseFee * data.count)}</span></div>}
