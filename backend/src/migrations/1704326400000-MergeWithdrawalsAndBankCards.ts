...
export class MergeWithdrawalsAndBankCards1704326400000 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        // 添加 ownerType 字段
        await queryRunner.addColumn('withdrawals', new TableColumn({
            name: 'ownerType',
            type: 'varchar',
            length: '20',
            default: "'buyer'",
        ...
        // 设置 ownerId 为非空
        await queryRunner.changeColumn('withdrawals', 'ownerId', new TableColumn({
            name: 'ownerId',
            type: 'uuid',
            isNullable: false
        }));
        ...
        // 添加索引
        await queryRunner.createIndex('withdrawals', new TableIndex({
        ...
        // 添加 ownerType 字段
        await queryRunner.addColumn('bank_cards', new TableColumn({
            name: 'ownerType',
            type: 'varchar',
            length: '20',
            default: "'buyer'",
        ...
        // 设置 ownerId 为非空
        await queryRunner.changeColumn('bank_cards', 'ownerId', new TableColumn({
            name: 'ownerId',
            type: 'uuid',
            isNullable: false
        }));
        ...
        // 添加索引
        await queryRunner.createIndex('bank_cards', new TableIndex({
        ...
        console.log('Migration completed: Merged withdrawals and bank_cards tables');
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        console.log('Rollback completed: Separated withdrawals and bank_cards tables');
    }
}
