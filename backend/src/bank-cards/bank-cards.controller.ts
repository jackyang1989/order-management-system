...
import { CreateBankCardDto, UpdateBankCardDto, BankCardStatus } from './bank-card.entity';
...
export class BankCardsController {
    ...
    async findAllForAdmin(
        ...
        const result = await this.bankCardsService.findAllForAdmin({
            ...
            status: status !== undefined && status !== '' ? parseInt(status) as BankCardStatus : undefined,
            keyword
        });
