...
import { CreateAdminUserDto, UpdateAdminUserDto, AdminLoginDto, CreateAdminRoleDto, AdminStatus } from './admin-user.entity';
...
export class AdminUsersController {
    ...
    @Post()
    @UseGuards(JwtAuthGuard)
    async create(@Body() createDto: CreateAdminUserDto, @Request() req, @Ip() ip: string) {
        try {
    ...
    @Post('roles')
    @UseGuards(JwtAuthGuard)
    async createRole(@Body() createDto: CreateAdminRoleDto, @Request() req, @Ip() ip: string) {
        try {
